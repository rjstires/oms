class Admin::EventSlotsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @event_slot.save
        format.html { redirect_to admin_events_path, notice: 'Event slot was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @event_slot.update(event_slot_params)
        format.html { redirect_to admin_events_path, notice: 'Event slot was successfully updated.' }
  ...
  def destroy
    @event_slot.destroy
    respond_to do |format|
      format.html { redirect_to admin_events_path, notice: 'Event slot was successfully destroyed.' }
  ...
  private
    ...
    def event_slot_params
      params.require(:event_slot).permit(:title, :description, :character_id)
    end
end

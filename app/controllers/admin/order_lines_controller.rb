class Admin::OrderLinesController < AdminController
  ...
  def destroy
    @order_line.destroy
    respond_to do |format|
      format.html { redirect_to admin_order_lines_url, notice: 'Order line was successfully destroyed.' }
  ...
  def send_confirmation
    ...
    redirect_back_or admin_order_lines_path(params[:order_line_id])
  end

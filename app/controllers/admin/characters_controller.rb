class Admin::CharactersController < AdminController
  ...
  def index
    ...
    .includes(:classification, :armor_type, :tier_token, :primary_stat)
    .order('classifications.name ASC, characters.spec ASC').all
  end
  ...
  private
    ...
    def character_params
      params.require(:character).permit(:spec, :classification_id, :armor_type_id, :tier_token_id, :primary_stat_id)
    end
end
